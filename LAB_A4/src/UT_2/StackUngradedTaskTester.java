...
public class StackUngradedTaskTester {
	...
	System.out.println("Demo of L2_Stck.UT_2.Stack class methods and L2_Stck.UT_2.Stack Printing\n");
	Stack s = new Stack();
        s.push(4);
        s.push(3);
        s.push(5);
	...
	s.pop();
        ...
        System.out.println("After Calling Conditional Reversed L2_Stck.UT_2.Stack:");
