...
/*You will have to complete the AT_1.UT_1.PairNode Contrustor first
...
public class HashTable {
    ...
    //ht is the AT_1.UT_1.HashTable array that stores the AT_1.UT_1.PairNode objects
    //It is an intance variable
    private PairNode[] ht;

    //Constructor that initializes the AT_1.UT_1.HashTable array
    ...
    //This method basically prints the AT_1.UT_1.HashTable
	//DO NOT change and DO NOT SUBMIT this method
    ...
    public void remove( Integer key ){
        int s = hashFunction(key);
        PairNode runner = ht[s];
        PairNode pre = null;
        if( ht[s] == null){
